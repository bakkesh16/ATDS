...
public class WardsEO {
     ...
     * @param status The status of the ward (e.g., OCCUPIED, VACANT).
     */
    ...
    */
     ...
     *
     * @param wardnumber The ward number to set.
     */
     ...
     *
     * @param wardtype The ward type to set.
     */
     ...
     *
     * @param status The ward status to set.
     */
